        ...
        {showFilter && (
          <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 mb-6 flex flex-wrap gap-6 justify-between">
            ...
            <div className="flex flex-col min-w-[180px] flex-1">
              ...
              >
                {REASONS.map(opt => <option key={opt}>{opt}</option>)}
              </select>
            </div>
            <div className="flex flex-col min-w-[180px] flex-1">
            ...
            <div className="flex w-full justify-end gap-3 mt-4">
              <button className="px-6 py-2 border border-gray-300 rounded-lg font-medium text-gray-600 hover:bg-gray-100" onClick={handleReset}>Reset</button>
              <button className="px-6 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700" onClick={handleApply}>Apply</button>
            </div>
          </div>
        )}
          ...
          <form onSubmit={handleFormSubmit} className="mb-8 bg-white p-6 rounded-xl shadow border border-gray-300 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input className="border rounded w-full px-4 py-3" value={form.expendedByName} onChange={e => setForm(f => ({ ...f, expendedByName: e.target.value }))} required />
              ...
              <div>
                ...
                <input className="border rounded w-full px-4 py-3" value={form.expendedByRank} onChange={e => setForm(f => ({ ...f, expendedByRank: e.target.value }))} required />
              ...
              <div>
                ...
                <input className="border rounded w-full px-4 py-3" value={form.expendedById} onChange={e => setForm(f => ({ ...f, expendedById: e.target.value }))} />
              </div>
              <div>
              ...
              <div>
                ...
                <input className="border rounded w-full px-4 py-3" value={form.location} onChange={e => setForm(f => ({ ...f, location: e.target.value }))} placeholder="Optional location" />
              </div>
            ...
            <div className="flex justify-end gap-4 mt-8">
              <button type="button" onClick={() => setShowForm(false)} className="px-6 py-2 border border-gray-300 rounded hover:bg-gray-100">Cancel</button>
              <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Create Expenditure</button>
            </div>
          </form>
        )}
          ...
          <table className="w-full border-collapse min-w-[650px] text-left text-[13px] text-[#182233]">
            ...
            <tbody>
              {paginatedRows.length === 0 ? (
                <tr>
                  <td colSpan={7} className="text-center p-4 text-gray-500">No expenditures found.</td>
                </tr>
                ...
                <tr className="border-b border-gray-100 hover:bg-[#F1FAFE]" key={idx}>
                  ...
                  <td className="px-3 py-4 border-r border-gray-300 text-blue-600 font-semibold text-sm hover:underline cursor-pointer text-right">
                    View
                  </td>
                </tr>
              ))}
