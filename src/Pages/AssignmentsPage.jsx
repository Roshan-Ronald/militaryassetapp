      ...
      <div className="flex justify-between items-center mb-6 flex-wrap gap-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex items-center gap-1 px-4 py-2 cursor-pointer rounded-lg text-sm font-semibold border border-[#CBD2E0] bg-white hover:bg-gray-50 focus:outline-none ${
        ...
        <form onSubmit={handleAddSubmit} className="mb-6 bg-white p-6 rounded-xl shadow border border-gray-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              placeholder="Asset"
              value={newData.asset}
              onChange={e => setNewData({ ...newData, asset: e.target.value })}
            />
            <select
              required
              className="border rounded px-3 py-2"
              value={newData.assetType}
              onChange={e => setNewData({ ...newData, assetType: e.target.value })}
            >
            ...
            <select
              ...
              className="border rounded px-3 py-2"
              value={newData.base}
              onChange={e => setNewData({ ...newData, base: e.target.value })}
            >
            ...
            <input
              ...
              type="text"
              className="border rounded px-3 py-2"
              placeholder="Assigned To (e.g. Squad Alpha)"
            ...
            <input
              ...
              onChange={e => setNewData({ ...newData, returned: e.target.value })}
            />
            <input
              required
            ...
            <input
              ...
              type="text"
              className="border rounded px-3 py-2"
              placeholder="Start Date (May 10, 2025)"
            ...
            <input
              ...
              type="text"
              className="border rounded px-3 py-2"
              placeholder="End Date (Aug 15, 2025)"
              value={newData.endDate}
              onChange={e => setNewData({ ...newData, endDate: e.target.value })}
            />
          </div>
          <div className="mt-4 flex justify-end gap-4">
            <button type="button" className="px-4 py-2 border rounded" onClick={() => setShowAddForm(false)}>
              Cancel
            </button>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-300 overflow-x-auto">
        ...
        <div className="flex flex-wrap justify-between items-center px-5 py-3 gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="px-2 py-1 rounded border border-gray-300 text-gray-900 disabled:opacity-50 cursor-not-allowed" disabled>
              &lt;
            </button>
